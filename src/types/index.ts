export type Role = 'ADMIN' | 'SALES_MANAGER' | 'SALES_EXECUTIVE' | 'RND_MANAGER' | 'PACKAGING_MANAGER';
...
export const STAGE_COLUMNS = [
  { id: 'new', name: 'New', stages: [0, 1] },
  { id: 'briefing', name: 'Briefing', stages: [2, 2.1, 3, 3.1] },
  { id: 'production', name: 'In Production', stages: [4, 5, 6, 7, 7.1, 8, 8.1] },
  { id: 'dispatch', name: 'Dispatch', stages: [9, 9.1, 10, 11, 12, 13] },
  { id: 'follow-up', name: 'Follow-Up', stages: [14, 15, 16] },
  { id: 'closing', name: 'Closing', stages: [17, 18, 19] },
];

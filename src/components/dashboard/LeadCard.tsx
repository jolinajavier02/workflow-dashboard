      ...
      <div className="flex justify-between items-start mb-3">
        ...
        <div className="flex items-center gap-1.5 text-[9px] font-black">
                {(() => {
                    ...
                    if (stageVal >= 9 && stageVal < 14) return <span className="flex items-center text-blue-600 bg-blue-50 px-2 py-1 rounded uppercase tracking-widest border border-blue-100 shadow-[inset_0_1px_4px_rgba(0,0,0,0.02)]"><RoleIcon/> PM</span>;
                    ...
                    if (stageVal >= 17) return <span className="flex items-center text-emerald-600 bg-emerald-50 px-2 py-1 rounded uppercase tracking-widest border border-emerald-100 shadow-[inset_0_1px_4px_rgba(0,0,0,0.03)]"><RoleIcon/> Completed</span>;
                    return null;
                })()}
        </div>
      </div>
